...
const About = () => {
    ...
    const openResume = () => {
        window.open(
            "https://drive.google.com/file/d/1QobwFs1Qpj78CZhoq4_L6EB7awVNa-eM/view?usp=sharing",
            "_blank"
        );
    };
        ...
        <Grid container id="about" className='about section' sx={{ width: "80%", margin: "10% auto", padding: "0% 10px" }} spacing={2}>
            <Grid item xs={12} sm={7} md={6} sx={{ margin: "auto" }}>
                <Box sx={{ borderTop: "2px solid rgb(151, 160, 161)", position: "relative" }}>
                    ...
                    <Typography id="user-detail-intro" className='aboutText' sx={{ marginTop: "8%",  color: darkMode ? "#fff" : "#333", fontFamily: "monospace" }}>
