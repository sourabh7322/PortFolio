            ...
            <Grid item xs={12} sm={6} md={6} sx={{ margin: "auto" }}>
                <Box sx={{ borderTop: "2px solid rgb(35, 53, 84)", position: "relative" }}>
                    ...
                    <Typography id="user-detail-intro" className='aboutText' sx={{ marginTop: "8%", color: "#008F11", fontFamily: "Poppins" }}>
                        Hello! My name is <span style={{ color: "#00FF41" }}>Sourabh</span> and I enjoy creating things that live on the internet. My interest in computers and technology started back when I was in my 6th grade and my father brought me a computer, and since then, I've been exploring various aspects of it.
                        <br /><br />
